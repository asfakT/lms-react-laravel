...
const LessonsSort = ({ showLessonSortModal, handleCloseLessonSortModal, lessonsData , setChapters}) => {
    ...
    const saveOrder = async (updatedlLessons) => {
        await fetch(`${apiUrl}/sort-lessons`, {
            ...
            body: JSON.stringify({ lessons: updatedlLessons })
        })
            .then(res => res.json())
            .then(result => {
    ...
    return (
        <>
            <Modal size='lg' show={showLessonSortModal} onHide={handleCloseLessonSortModal} animation={false}>
