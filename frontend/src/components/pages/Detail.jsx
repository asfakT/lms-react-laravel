...
import { apiUrl, getToken, convertMinutesToHours } from '../common/Config'
                  ...
                  <div className='row'>
                    ...
                    <div className='col-md-12 mt-4'>
                      <div className='border bg-white rounded-3 p-4'>
                        ...
                        <p>
                          {course.chapters_count} Chapters . {course.total_lessons} Lecture . {convertMinutesToHours(course.total_duration)}
                              ...
                              return (
                                <Accordion.Item eventKey={index.toString()}
                                  ...
                                  <Accordion.Body>
                                    <ListGroup>
                                      {
                                        chapter.lessons && chapter.lessons.map((lesson, i) => (
