    ...
    return (
        <div className="col-md-4">
            <div className='card border-0 position-relative'>
                {
                    course.status == 0 && <span className="fw-bold badge bg-light text-muted position-absolute top-0 end-0 m-2 z-3">Draft</span>
                }
                {
                    course.status == 1 && <span class="fw-bold badge bg-success position-absolute top-0 end-0 m-2 z-3">Published</span>
                }
                    ...
                    <div className="meta d-flex py-2">
                        <div className="level">
                            <div class="d-flex align-items-center">
                                {
                                    course.level && <div className='d-flex'>
                                        <div class="icon">
